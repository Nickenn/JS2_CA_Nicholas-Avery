...
export const userRegistrationForm = document.querySelector("#user-registration");
export const userRegistrationMessage = document.querySelector(".user-registration-message");
